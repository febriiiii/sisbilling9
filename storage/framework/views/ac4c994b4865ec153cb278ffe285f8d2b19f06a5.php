                                              ...
                                              `<ul style="padding: 0;">` +
                                                  ...
                                                  `<li style="list-style-type: none;" class="row">` +
                                                      `<span class="icon col-auto" style="margin-right:0px;">` +
                                                          `<img width="20" height="20" src="<?php echo e(asset('public/checklist.png')); ?>" alt="checkmark--v1"/>` +
                                                      `</span>` +
...
</script><?php /**PATH C:\xampp\htdocs\sisbilling9\resources\views/tabs/mybilling.blade.php ENDPATH**/ ?>