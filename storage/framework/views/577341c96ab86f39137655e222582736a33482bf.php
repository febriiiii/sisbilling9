  ...
  <section class="error">
    ...
    <div class="error__content">
      <div class="error__message message">
        <h1 class="message__title" style="color:rgb(153, 153, 153);">Page Not Found</h1>
        <p class="message__text" style="color:rgb(163, 163, 163);">We're sorry, the page you were looking for isn't found here. The link you followed may either be broken or no longer exists. Please try again, or take a look at our.</p>
        <a href="https://api.whatsapp.com/send?phone=6281275650284" style="color:rgb(163, 163, 163);">M-Billing Support Center</a>
      </div>
      <div class="error__nav e-nav">
        <a href="<?php echo e(url('')); ?>" class="e-nav__link"></a>
      </div>
    </div>
    <!-- END Content -->
