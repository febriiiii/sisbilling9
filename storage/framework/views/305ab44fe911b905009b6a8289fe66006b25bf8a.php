    ...
    <div class="container" style="margin-top:15vh; z-index:3;">
        ...
        <center>
            <div style="max-width: 500px">
                ...
                <h6><i style="color: red">Periksa spam anda jika email tidak ditemukan di kotak masuk</i></h6>
    ...
    $('#submitmailotp').submit(function(e){
        ...
        $.ajax({
            ...
            success: function(response) {
                if(response == 0){
                    showNty('Email Tidak Ditemukan',4000)
                }else{
                    var email = $('#displayForgot_email').val()
                    showNty('OTP Berhasil Dikirim')
                    $('#otp').show()
                    $('#otp').unbind()
