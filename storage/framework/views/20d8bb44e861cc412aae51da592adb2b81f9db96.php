<style>
  ...
  <script>
    ...
    var pivotGrid = $('#pivotgrid').dxPivotGrid({
      ...
      dataSource: {
        ...
        store: {
          type: 'odata',
          url: "<?php echo e(url('')); ?>/pivot?stamp=" + new Date().getTime(),
          key: 'notrans',
          beforeSend(request) {
  ...
  </script><?php /**PATH C:\xampp\htdocs\sisbilling9\resources\views/getView/viewPivotmybilling.blade.php ENDPATH**/ ?>