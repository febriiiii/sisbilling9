...
<button onclick="window.location.href='<?php echo e(url('/')); ?>'" class="btn btn-primary m-3" style="padding:5px 10px 5px 5px; border-radius:100%;"><i class="las la-backspace" style="font-size: 40px;"></i></button>
    <div class="container" style="padding-bottom: 15vh;"> 
        <form id="submitRgstr" class="container" style="margin-top:8vh; z-index:3;" method="POST" action="<?php echo e(url('register')); ?>?stmp=<?php echo e(time()); ?>">
            <?php echo csrf_field(); ?>
            <center>
...
unset($__errorArgs, $__bag); ?>
                      <div class="row" style="margin:0;">
                          <div class="form-outline col mt-3">
                              <input <?php $__errorArgs = ['otp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> value='******' <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?> name="password" type="password" id="displayRegister_password" class="form-control <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> name="password2" type="password" id="displayRegister_password2" class="form-control <?php $__errorArgs = ['password2'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                <div class="alert alert-danger col mt-3"><?php echo e($message); ?></div>
                              <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
unset($__errorArgs, $__bag); ?>
                    <div class="mt-4">
                        <input class="form-check-input" name="term" type="checkbox" role="switch" id="flexSwitchCheckDefault" <?php if($errors->any()): ?> checked <?php endif; ?> />
