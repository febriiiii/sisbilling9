    ...
    dataSource: {
      store: new DevExpress.data.CustomStore({
        ...
        insert: function(values) {
          return $.ajax({
            url: "<?php echo e(url('dataviewproducttypeInsert')); ?>",
            method: "POST",
            cache: false,
            headers: {
        ...
        update: function(key, values) {
          return $.ajax({
            url: "<?php echo e(url('dataviewproducttypeUpdate')); ?>",
            method: "POST",
            cache: false,
            data: {
                _token: '<?php echo e(csrf_token()); ?>',
        ...
        remove: function(key) {
          return $.ajax({
            url: "<?php echo e(url('dataviewproducttypeDelete')); ?>",
            method: "POST",
            cache: false,
            data: {
                _token: '<?php echo e(csrf_token()); ?>',
...
<?php /**PATH C:\xampp\htdocs\sisbilling9\resources\views/getView/viewProductType.blade.php ENDPATH**/ ?>