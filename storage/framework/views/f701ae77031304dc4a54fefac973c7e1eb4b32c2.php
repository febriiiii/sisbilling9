...
<script>
    ...
    // setTimeout(() => {
        ...
        $('#sendmsgimgprivate').click(function(){
            ...
            $.ajax({
                url: '<?php echo e(url("/sendimgchat")); ?>',
                type: 'POST',
                cache: false,
                data: formData,
                processData: false,
    ...
    $.ajax({
        type: 'POST',
        cache: false,
        url: '<?php echo e(url("/getchatd")); ?>',
        data: {chatid},
        success: function(data) {
            contentchat.html("")
            var urli = 'public/storage/'+data.header.profileImg
            var header = `<div class="">`+
                            `<img src="<?php echo e(asset('')); ?>`+urli+`" width="30" height="30" style="border-radius:100%;">`+
            ...
            data.detail.forEach(e => {
                ...
                if(e.description != "!@##@!IMG!@##@!"){
                    ...
                    msg = `<div style="background-image: url('<?php echo e(asset('/public/storage/chatimg')); ?>/`+e.id+`.png'); background-size: cover; width: 180px; height:130px;"></div>
    ...
    //             if("<?php echo e(isset(session('UIDGlob')->userid)?session('UIDGlob')->userid:null); ?>" == data.authuser){
    //                 position = "right"
    //                 name = ""
    //             }
...
<?php /**PATH C:\xampp\htdocs\sisbilling9\resources\views/getView/viewChat.blade.php ENDPATH**/ ?>