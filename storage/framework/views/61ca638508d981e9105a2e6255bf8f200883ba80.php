<div class="container">
  <div class="row mb-2">
      ...
      <div class="col-sm mt-2"><h5 style="position: absolute; z-index:100;">Penggunaan <?php echo e(explode(" ", $nama)[0]); ?></h5><div id="userIn"></div></div>
  </div>
  <hr>
...
<script>
  ...
  function onAdd(a) {
    $.ajax({
      type: 'GET',
      cache: false,
      url: '<?php echo e(url("/getPokok?AppointmentId=")); ?>' + a.itemData.AppointmentId, 
