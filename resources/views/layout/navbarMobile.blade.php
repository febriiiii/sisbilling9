    ...
    <div class="navbarWrap">
      <div class="navbar">
        <ul class="menu uk-subnav uk-subnav-pill" uk-switcher="animation: uk-animation-scale-up, uk-animation-fade; connect: .switcher-navbarCustom">
          ...
          @if ((session('UIDGlob')->companyid != '' && session('UIDGlob')->scrb > 0) || session('UIDGlob')->superadmin == 1)
          ...
          <li class="menu__item" style="--bgColorItem:rgb(169, 209, 90);">
            <div class="navbarCustomIconX" title="Profile">
              <div style="border: 2px solid #F8F8F8; background-image: url('{{asset('public/storage/'.session('UIDGlob')->profileImg)}}'); width: 25px; height: 25px; border-radius: 100%; background-position: center; background-size: contain;"></div>
              {{-- <lord-icon
